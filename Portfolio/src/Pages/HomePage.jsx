...
const HomePage = () => {
return (
    <div className="h-[calc(100vh-10vh)] w-[100vw] bg-[#222831] grid grid-cols-2 md:grid-cols-2">
        <div className="content text-white flex flex-col items-center justify-center">
            ...
            <div className="btns-container flex gap-4">
                ...
                <button className="outline outline-1 outline-white p-2 rounded-full px-6 hover:bg-white hover:outline-cyan-400 hover:text-black">
                    <a href={Heropic} download>Download CV</a>
                </button>
                <div>
